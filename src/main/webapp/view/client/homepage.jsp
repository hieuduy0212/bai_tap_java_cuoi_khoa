...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="https://cdn-icons-png.flaticon.com/512/25/25694.png" alt="" width="72" height="57">
      <h2>Staff Homepage</h2>
      <p class="lead">Information of staff will be showed here</p>
    </div>
